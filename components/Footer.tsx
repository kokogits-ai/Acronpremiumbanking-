      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="pt-8 border-t border-slate-200">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="bg-amber-50 border border-amber-100 px-4 py-2 rounded text-[10px] text-amber-700 font-medium uppercase tracking-tighter max-w-md text-center">
              Notice: This website is for demonstration purposes only. Acron Bank is a fictional entity created for this interface prototype.
            </div>
          </div>
        </div>
      </div>
